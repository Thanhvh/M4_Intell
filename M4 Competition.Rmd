...
## Create a data frame to sumarize the M4 data structure
```{r, message=FALSE, warning=FALSE}
...
## Extract M4 data: yearly, quarterly, monthly, dayly, hourly
```{r, message=FALSE, warning=FALSE}
...
## Extract one sample month to perform statistical models
...
```
## Explore time series patterns: Trend, seasonal, or cyclic
```{r, message=FALSE, warning=FALSE}
